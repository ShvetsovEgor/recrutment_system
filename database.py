    ...
    def add_matching_result(self, candidate_id: int, vacancy_id: int, score: float, 
        ...
        with self.get_connection() as conn:
            ...
            """, (
                vacancy_id,
                candidate_id,
                ((detailed_scores.get('age_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('location_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('work_exp_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('education_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('skills_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('skills_tech_score') or 0) if detailed_scores else 0) * 100,
                ((detailed_scores.get('languages_score') or 0) if detailed_scores else 0) * 100,
